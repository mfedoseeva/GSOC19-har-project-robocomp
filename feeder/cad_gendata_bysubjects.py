...
def gendata(data_path,
    ...
    for s in range(subjects):
        ...
        out_path_s = os.path.join(out_path, str(s))
        os.makedirs(out_path_s, exist_ok=True)
        ...
        with open('{}/{}_label.pkl'.format(out_path_s, part), 'wb') as f:
        ...
        fp = open_memmap(
            '{}/{}_data.npy'.format(out_path_s, part),
            dtype='float32',
            mode='w+',
        ...
        fl = open_memmap(
            '{}/{}_num_frame.npy'.format(out_path_s, part),
            dtype='int',
            mode='w+',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data0/CAD-60/by_subjects')
