...
## Review of papers on different architectures and their achieved scores on NTU-RGB-D
 ...
 | Co-occurence learning with CNN | [link](https://arxiv.org/abs/1804.06055) | 86.5 - 91.1 | [link](https://github.com/huguyuehuhu/HCN-pytorch)| Also 2-stream, first stream is raw data, the second id joint-wise difference between joint coodrinates at time t+1 and t. Streams are later fused by concatenation along the channels. After two conv layers, the input is transposed so that joints are not channels | ran the reimplementation of this model, got accuracy of 89.3 for cross-view, used smaller batch-size |
...
## Datasets
 ...
 | UWA 3D Multiview II | [link](http://staffhome.ecm.uwa.edu.au/~00053650/databases.html) | 10 | 30 | 4 | ? | 1076 | most probably 20 joints. multi-view was captured by moving the camera and repeating the cation, rather than filming one action from diff. cameras|
 | MSR Action3D | [link](https://www.uow.edu.au/~wanqing/#Datasets) | 10 | 20 | ? | 20 | 567 | most probablu single-view |
 | J-HMDB | [link](http://jhmdb.is.tue.mpg.de/challenge/JHMDB/datasets) | - | 21 | - | 13 | 928 | collected from internet videos, including outdoor environments, but these 928 samples are full body |
